...
source /home/ubuntu/mcp_server_project/backend/venv/bin/activate
...
gunicorn --workers 2 --worker-class gevent --bind 0.0.0.0:5000 app:app --timeout 120 --log-file /home/ubuntu/mcp_server_project/backend/server.log --log-level debug
